...
class _ProfileApi implements ProfileApi {
  ...
  @override
  Future<ProfileResponse> updateProfile(ProfileUpdateRequest data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ProfileResponse> changePassword(PasswordChangeRequest data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ProfileResponse> uploadAvatar(List<MultipartFile> avatar) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
